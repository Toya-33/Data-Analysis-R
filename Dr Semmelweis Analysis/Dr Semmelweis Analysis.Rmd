...
```
**Insight:** Due to the limitation of our data, our histogram look a bit jagged. However, we can estimate what the distribution would look like with a Kernel Density Estimate (KDE).
...
```
**Insight:** Now, it's easier and clearer to confirm that for handwashing, the distribution of the death rate is more skewed to the right compared to the flatter distribution observed in the absence of handwashing. This further reinforces our argument in favor of handwashing.
